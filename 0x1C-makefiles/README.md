...
Project done during **Full Stack Software Engineering studies** at **ALX Arica SE**. It aims to learn what are makefiles, when, why and how to use them (with variables, explicit and implicit rules).
